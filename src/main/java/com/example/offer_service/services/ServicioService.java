...
public class ServicioService {
    ...
    public List<Servicio> filtrarProveedoresCercanos(Long clienteId, Double radioKm) {
        List<ProveedorResponse> proveedores = proveedoresCercanos.obtenerCercanos(clienteId, radioKm);
